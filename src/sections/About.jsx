    ...
    return (
        <div className="flex flex-col gap-5 c-space ">
            ...
            <div className="flex flex-col gap-5 c-space md:flex-row">
                <div
                    className="w-full md:w-1/2  rounded-md p-14 flex justify-center items-center md:p-10">
            ...
            <div className="grid xl:grid-cols-3 xl:grid-rows-6 md:grid-cols-2 grid-cols-1 gap-5 h-full c-space">
                <div className="col-span-1 xl:row-span-3">
                    <div className="grid-container">
                        ...
                        {/*</Canvas>*/}
                        <img src="./images/flyer-pata.png" alt="Eva" className="w-full h-full rounded-3xl mb-10"/>
                ...
                <div className="col-span-1 xl:row-span-3">
                    <div className="grid-container flex justify-center">
                        <div>
                            <img src="./images/flyer-pata2.jpg" alt="Eva" className="w-full h-full rounded-3xl mb-10"/>
                ...
                <div className="grid-container">
                    ...
                    <div className="rounded-3xl w-full sm:h-[326px] h-[700px]  justify-center ">
                        ...
                        <img src="./images/flyer-pata3.jpg" alt="Eva" className="w-full h-full rounded-3xl mb-10"/>
                ...
                <div className="grid-container">
                    ...
                    <div>
                        <img src="./images/flyer-pata4.png" alt="Eva" className="w-full h-full rounded-3xl mb-10"/>
                ...
                <div className="col-span-1 xl:row-span-3">
                    <div className="grid-container flex justify-center">
                        ...
                        <img src="./images/flyer-pata5.png" alt="Eva" className="w-full h-full rounded-3xl mb-10"/>
                    </div>
                </div>
